...
{
    public class DbLocalCiphertextContentEncrypt :DbContext
    {
        ...
        public DbLocalCiphertextContentEncrypt() 
        {
            // รับพาธไปยังโฟลเดอร์ "Documents" ของผู้ใช้ปัจจุบัน
            string documentsPath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);

            // กำหนดชื่อโฟลเดอร์ที่ต้องการสร้าง
            myAppFolderPath = Path.Combine(documentsPath, "MyPassDocument\\LocalCiphertexts");
